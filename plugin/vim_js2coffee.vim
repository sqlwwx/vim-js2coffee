...
"  Function
" -----------------------------
function! DoConversion(type, selection_or_buffer)
python << endPython
...
" -----------------------------
"  Expose command to the user
" -----------------------------
command! JSBuffer2Coffee call DoConversion("javascript", "buffer")
command! -range JSSelection2Coffee call DoConversion("javascript", "selection")
command! CoffeeBuffer2JS call DoConversion("coffee", "buffer")
command! -range CoffeeSelection2JS call DoConversion("coffee", "selection")
